...
**Validation standard:** 30d backtest, runner-modeled ([BACKTEST] $2 min, 90% deploy, session gate)
...
|------|----------|----------|----------------|-------|--------|
| 1 | **momentum** | breakout | [BACKTEST] $+4,472.16 | 8/9 | 30d_modeled |
| 2 | **fibonacci_breakout** | breakout | [BACKTEST] $+3,582.61 | 5/5 | 30d_modeled |
| 3 | **rsi_mean_reversion** | mean_reversion | [BACKTEST] $+3,289.00 | 1/1 | 30d_modeled_single_coin |
| 4 | **supertrend** | trend_following | [BACKTEST] $+2,704.98 | 5/5 | 30d_modeled |
| 5 | **time_decay_signal** | time_based | [BACKTEST] $+915.71 | 5/5 | 30d_modeled |
| 6 | **ma_atr** | hybrid | [BACKTEST] $+543.68 | 4/5 | 30d_modeled |
...
- **Total PnL (30d):** [BACKTEST] $+3,582.61
- **Coins:** 5/5 profitable
- **Best coin:** NOM-USD ([BACKTEST] $+2,019.18)
- **Source:** local generated report excluded from public snapshot

| Coin | PnL | WR% | Trades | Signals |
|------|-----|-----|--------|--------|
| GHST-USD | [BACKTEST] $+440.39 | 45.7% | 223 | 223 |
| NOM-USD | [BACKTEST] $+2,019.18 | 48.8% | 303 | 303 |
| RAVE-USD | [BACKTEST] $+621.96 | 53.8% | 186 | 186 |
| SUP-USD | [BACKTEST] $+179.37 | 48.6% | 109 | 109 |
| TRU-USD | [BACKTEST] $+321.71 | 47.7% | 132 | 132 |
...
- **Total PnL (30d):** [BACKTEST] $+2,704.98
- **Coins:** 5/5 profitable
- **Best coin:** RAVE-USD ([BACKTEST] $+1,094.94)
- **Source:** local generated report excluded from public snapshot

| Coin | PnL | WR% | Trades | Signals |
|------|-----|-----|--------|--------|
| GHST-USD | [BACKTEST] $+101.80 | 34.6% | 217 | 217 |
| NOM-USD | [BACKTEST] $+1,079.15 | 40.6% | 278 | 278 |
| RAVE-USD | [BACKTEST] $+1,094.94 | 51.4% | 146 | 146 |
| SUP-USD | [BACKTEST] $+76.41 | 35.1% | 111 | 111 |
| TRU-USD | [BACKTEST] $+352.68 | 42.6% | 136 | 136 |
...
- **Total PnL (30d):** [BACKTEST] $+915.71
- **Coins:** 5/5 profitable
- **Best coin:** RAVE-USD ([BACKTEST] $+516.86)
- **Source:** local generated report excluded from public snapshot

| Coin | PnL | WR% | Trades | Signals |
|------|-----|-----|--------|--------|
| GHST-USD | [BACKTEST] $+122.32 | 43.2% | 81 | 81 |
| NOM-USD | [BACKTEST] $+199.10 | 43.4% | 122 | 122 |
| RAVE-USD | [BACKTEST] $+516.86 | 60.5% | 76 | 76 |
| SUP-USD | [BACKTEST] $+10.15 | 43.9% | 41 | 41 |
| TRU-USD | [BACKTEST] $+67.28 | 53.6% | 56 | 56 |
...
- **Total PnL (30d):** [BACKTEST] $+543.68
- **Coins:** 4/5 profitable
- **Best coin:** RAVE-USD ([BACKTEST] $+235.32)
- **Source:** local generated report excluded from public snapshot

| Coin | PnL | WR% | Trades | Signals |
|------|-----|-----|--------|--------|
| GHST-USD | [BACKTEST] $-7.39 | 30.8% | 78 | 78 |
| NOM-USD | [BACKTEST] $+234.73 | 45.0% | 109 | 109 |
| RAVE-USD | [BACKTEST] $+235.32 | 57.1% | 63 | 63 |
| SUP-USD | [BACKTEST] $+60.46 | 36.4% | 55 | 55 |
| TRU-USD | [BACKTEST] $+20.56 | 32.5% | 80 | 80 |
...
- **Total PnL (30d):** [BACKTEST] $+4,472.16
- **Coins:** 8/9 profitable
- **Best coin:** NOM-USD ([BACKTEST] $+1,807.91)
- **Source:** local generated report excluded from public snapshot

| Coin | PnL | WR% | Trades | Signals |
|------|-----|-----|--------|--------|
| A8-USD | [BACKTEST] $+122.72 | 52.5% | 59 | 59 |
| BAL-USD | [BACKTEST] $+65.73 | 52.0% | 25 | 25 |
| CFG-USD | [BACKTEST] $+85.97 | 44.1% | 68 | 68 |
| GHST-USD | [BACKTEST] $+692.86 | 61.4% | 57 | 57 |
| IOTX-USD | [BACKTEST] $-5.89 | 35.3% | 68 | 68 |
| NOM-USD | [BACKTEST] $+1,807.91 | 48.5% | 132 | 132 |
| RAVE-USD | [BACKTEST] $+1,049.37 | 68.1% | 72 | 72 |
| SUP-USD | [BACKTEST] $+118.94 | 43.1% | 58 | 58 |
| TRU-USD | [BACKTEST] $+534.55 | 53.2% | 79 | 79 |
...
- **Total PnL (30d):** [BACKTEST] $+3,289.00
- **Coins:** 1/1 profitable
- **Best coin:** MOG-USD ([BACKTEST] $+3,289.00)
- **Source:** local research note excluded from public snapshot

| Coin | PnL | WR% | Trades | Signals |
|------|-----|-----|--------|--------|
| MOG-USD | [BACKTEST] $+3,289.00 | 36.1% | verified | verified |
