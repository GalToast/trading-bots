...
TICKS_PATH = ROOT / "reports" / "cache" / "coinbase_spot_live_radar_ticks.json"
PULSE_CANDLES_PATH = ROOT / "reports" / "cache" / "coinbase_spot_pulse_candles.json"
OUTPUT_PATH = ROOT / "reports" / "coinbase_spot_live_foundry_features.json"

def main():
    print("=" * 80)
    print("COINBASE LIVE FOUNDRY BRIDGE (CANDLE-BACKED)")
    print("=" * 80)
    ...
    # 2. Supplementary Tick features (if needed, but Pulse is better for volume)
    # ... ignoring ticks for now since Pulse covers 3h.
