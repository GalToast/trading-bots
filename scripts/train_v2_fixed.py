#!/usr/bin/env python3
"""Train V2 FIXED tail predictor (no leakage)."""
import pandas as pd
import numpy as np
...
print("=" * 60)
print("TRAINING V2 FIXED (no leakage)")
print("=" * 60)
...
# Evaluate
print("\nEvaluating V2 FIXED model...")
y_prob = model.predict_proba(X_test)[:, 1]
auc = roc_auc_score(y_test, y_prob)
ap = average_precision_score(y_test, y_prob)

print(f"ROC AUC: {auc:.4f} (vs 0.6498 V1, 1.0 V2_WITH_LEAKAGE)")
...
joblib.dump({
    ...
    'test_auc': auc,
    'test_ap': ap,
    'version': 'V2 FIXED (no leakage)',
}, 'reports/models/coinbase_spot_high_gross_tail_predictor_v2_fixed.joblib')

print("Done! Model saved to: reports/models/coinbase_spot_high_gross_tail_predictor_v2_fixed.joblib")
print("=" * 60)
