...
"""Register and optionally launch the FX M1 micro-harvest live research lanes."""
...
LANE_SPECS: dict[str, dict[str, Any]] = {
    "GBPUSD": {
        "lane_name": "live_gbpusd_m1_snake_microharvest_941795",
        "live_magic": 941795,
        "state_path": "reports/live_gbpusd_m1_snake_microharvest_state.json",
        "event_path": "reports/live_gbpusd_m1_snake_microharvest_events.jsonl",
        "exec_state_path": "reports/live_gbpusd_m1_snake_microharvest_exec_state.json",
        "exec_log_path": "reports/live_gbpusd_m1_snake_microharvest_exec_events.jsonl",
        "step_pips": "0.1",
        "retrace_steps": "1",
        "hold_frontier": "0",
        "rebase_on_flat": True,
        ...
        "liquidity_gap_spread_floor_ratio": "14.0",
        "min_harvest_profit_usd": "0.35",
        "variant_label": "snake_step0.1pip_retrace1_hold0_static_float_zero_hedgesame_level_cap16_rebase",
        "winner_booked_usd_per_hour": 3.376,
    },
    "EURUSD": {
        "lane_name": "live_eurusd_m1_snake_microharvest_941796",
        "live_magic": 941796,
        "state_path": "reports/live_eurusd_m1_snake_microharvest_state.json",
        "event_path": "reports/live_eurusd_m1_snake_microharvest_events.jsonl",
        "exec_state_path": "reports/live_eurusd_m1_snake_microharvest_exec_state.json",
        "exec_log_path": "reports/live_eurusd_m1_snake_microharvest_exec_events.jsonl",
        "step_pips": "0.1",
        "retrace_steps": "1",
        "hold_frontier": "0",
        "rebase_on_flat": True,
        ...
        "winner_booked_usd_per_hour": 1.025,
    },
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="FX M1 micro-harvest live launcher")
