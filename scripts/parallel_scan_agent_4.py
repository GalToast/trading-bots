#!/usr/bin/env python3
"""
Parallel RSI Mean-Reversion Scan — Chunk 150-199
=================================================
Scans coins at lines 150-199 (0-indexed) of coinbase_usd_pairs.txt.
...
REPORT_PATH = ROOT / "reports" / "parallel_scan_chunk_150_199.json"
...
def main():
    print("=" * 70)
    print("  RSI Mean-Reversion Scan -- Chunk 150-199")
    ...
    slice_coins = coins[150:200]  # indices 150-199 inclusive (50 coins)
    print(f"\nCoins to scan: {len(slice_coins)} (indices 150-199)")
